--override-release-repository-push-url https://github.com/at-wat/neonavigation-release.git neonavigation` on `Tue, 04 Feb 2020 11:36:40 -0000`
...
## neonavigation (kinetic) - 0.7.0-1

The packages in the `neonavigation` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -y --no-web --ros-distro kinetic --override-release-repository-push-url https://github.com/at-wat/neonavigation-release.git neonavigation` on `Tue, 04 Feb 2020 11:32:51 -0000`
...
## neonavigation (melodic) - 0.6.0-1

The packages in the `neonavigation` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release neonavigation --track melodic --ros-distro melodic` on `Tue, 21 Jan 2020 04:18:54 -0000`
...
## neonavigation (kinetic) - 0.6.0-1

The packages in the `neonavigation` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release neonavigation --track kinetic --ros-distro kinetic` on `Tue, 21 Jan 2020 04:10:18 -0000`
...
## neonavigation (melodic) - 0.5.1-1

The packages in the `neonavigation` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release neonavigation --track melodic --ros-distro melodic` on `Wed, 08 Jan 2020 03:45:05 -0000`
...
## neonavigation (kinetic) - 0.5.1-1

The packages in the `neonavigation` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release neonavigation --track kinetic --ros-distro kinetic` on `Wed, 08 Jan 2020 03:32:59 -0000`
...
## neonavigation (melodic) - 0.5.0-1

The packages in the `neonavigation` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release neonavigation --track melodic --ros-distro melodic` on `Mon, 21 Oct 2019 05:00:01 -0000`
...
## neonavigation (kinetic) - 0.5.0-1

The packages in the `neonavigation` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release neonavigation --track kinetic --ros-distro kinetic` on `Mon, 21 Oct 2019 04:45:52 -0000`
...
## neonavigation (melodic) - 0.4.3-1

The packages in the `neonavigation` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release neonavigation --track melodic --ros-distro melodic` on `Mon, 09 Sep 2019 21:33:44 -0000`
...
## neonavigation (kinetic) - 0.4.3-1

The packages in the `neonavigation` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release neonavigation --track kinetic --ros-distro kinetic` on `Mon, 09 Sep 2019 21:23:54 -0000`
...
## neonavigation (melodic) - 0.4.2-1

The packages in the `neonavigation` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release neonavigation --track melodic --ros-distro melodic` on `Mon, 19 Aug 2019 10:48:06 -0000`
...
## neonavigation (kinetic) - 0.4.2-1

The packages in the `neonavigation` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release neonavigation --track kinetic --ros-distro kinetic` on `Mon, 19 Aug 2019 10:26:15 -0000`
...
## neonavigation (melodic) - 0.4.1-1

The packages in the `neonavigation` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release neonavigation --track melodic --ros-distro melodic` on `Fri, 16 Aug 2019 03:51:09 -0000`
...
## neonavigation (kinetic) - 0.4.1-1

The packages in the `neonavigation` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release neonavigation --track kinetic --ros-distro kinetic` on `Fri, 16 Aug 2019 03:24:25 -0000`
...
## neonavigation (kinetic) - 0.4.0-1

The packages in the `neonavigation` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release neonavigation --track kinetic --ros-distro kinetic` on `Thu, 09 May 2019 14:19:21 -0000`
...
## neonavigation (indigo) - 0.3.1-0

The packages in the `neonavigation` repository were released into the `indigo` distro by running `/usr/local/bin/bloom-release neonavigation --track indigo --ros-distro indigo` on `Thu, 10 Jan 2019 04:35:26 -0000`
...
## neonavigation (lunar) - 0.2.3-0

The packages in the `neonavigation` repository were released into the `lunar` distro by running `/usr/local/bin/bloom-release neonavigation --track lunar --ros-distro lunar` on `Thu, 19 Jul 2018 04:53:08 -0000`
...
## neonavigation (kinetic) - 0.2.3-0

The packages in the `neonavigation` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release neonavigation --track kinetic --ros-distro kinetic` on `Thu, 19 Jul 2018 04:27:34 -0000`
...
## neonavigation (indigo) - 0.2.3-0

The packages in the `neonavigation` repository were released into the `indigo` distro by running `/usr/local/bin/bloom-release neonavigation --track indigo --ros-distro indigo` on `Thu, 19 Jul 2018 04:20:12 -0000`
...
## neonavigation (lunar) - 0.2.2-0

The packages in the `neonavigation` repository were released into the `lunar` distro by running `/usr/local/bin/bloom-release neonavigation --track lunar --ros-distro lunar` on `Tue, 17 Jul 2018 11:05:22 -0000`
...
## neonavigation (lunar) - 0.2.1-0

The packages in the `neonavigation` repository were released into the `lunar` distro by running `/usr/local/bin/bloom-release neonavigation --track lunar --ros-distro lunar` on `Mon, 16 Jul 2018 12:30:22 -0000`
...
## neonavigation (kinetic) - 0.2.1-0

The packages in the `neonavigation` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release neonavigation --track kinetic --ros-distro kinetic` on `Mon, 16 Jul 2018 12:21:25 -0000`
...
## neonavigation (indigo) - 0.2.1-0

The packages in the `neonavigation` repository were released into the `indigo` distro by running `/usr/local/bin/bloom-release neonavigation --track indigo --ros-distro indigo` on `Sat, 14 Jul 2018 15:25:10 -0000`
...
## neonavigation (indigo) - 0.2.0-0

The packages in the `neonavigation` repository were released into the `indigo` distro by running `/usr/local/bin/bloom-release neonavigation --track indigo --ros-distro indigo --edit` on `Thu, 12 Jul 2018 10:03:13 -0000`
